...
BLOG_AUTHOR = "Ken Stewart"
BLOG_TITLE = "Tesla Metamorphosis" # - a modality for healing and evolving" #"Sparkle of Life" 
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sparkle-of-life.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sparkle-of-life.github.io/"
BLOG_EMAIL = "ken@example.com"
BLOG_DESCRIPTION = "Website: Sparkle of Life"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        (        
            (
                ('/tesla-metamorphosis/', 'Tesla Metamorphosis'),
                ('/tesla-healing-metamorphosis/','Tesla Healing Metamorphosis'),
                ('/tesla-soul-communitcation/', 'Tesla Soul Communication'),
                ('/tesla-light-body-metamorphosis/', 'Tesla Light Body Metamorphysis'),
            ),
            'Tesla Metamorphosis'
        ),
        (        
            (
                ('/tesla-wave/', 'Tesla Waves'),
                ('/tesla-waves-in-healing/','Tesla Waves in Healing'),
            ),
            'Tesla Waves'
        ),
        (        
            (
                ('/sessions/', 'Sessions'),
                ('/about-ken-stewart/','About Ken Stewart'),
            ),
            'Sessions'
        ),
        (        
            (
                ...
                ('/conditioning-the-space/', 'Conditioning the Space'),
                ('/differences-healing-vs-light-body/','Differences: Healing and Light Body'),
            ),
            'Blog'
        ),                        
        ("/contact/", "Contact"),
...
"""
about.md
conditioning-the-space.md
contact.md
differences-healing-vs-light-body.md
index.md
sessions.md
tesla-healing-metamorphosis.md
tesla-light-body-metamorphosis.md
tesla-metamorphosis.md
tesla-soul-communitcation.md
tesla-wave.md
tesla-waves-in-healing.md
what-is-healing.md
...
# Ian -🐈
# LOGO_URL = ''
LOGO_URL = '/images/Logo-small-1.png'
...
# )
FAVICONS = (
     #("icon", "/images/favicon.ico", "xx x xx"),
     ("icon", "/images/favicon-16x16.png", "16 x 16"),
     ("icon", "/images/favicon-32x32.png", "32 x 32"),     
)
